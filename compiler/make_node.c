...
node_t * make_main_node( node_t * first , node_t * second){
...
node_t * make_declare_var_node(char * name , node_t * value , variable_type type){
...
node_t * make_define_var_node(char * name , node_t * value){
